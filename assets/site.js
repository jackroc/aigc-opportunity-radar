const DIRECTORY_SOURCES = Object.freeze({
  ...
  // A future task-platform channel can be added here without changing the page shell.
});

const translations = {
  zh: {
    pageTitle: "AIGC 机会雷达｜创作比赛与任务机会",
    skipLink: "跳到主要内容",
    ...
    viewFullList: "查看完整清单",
    futureKicker: "Next channel",
    futureTitle: "下一站：找到比赛，<em>也找到可以接的任务。</em>",
    futureIntro: "后续会整理全球可接单、可投稿、可领取创作任务的平台，并按技能、地区、结算方式和风险提示进行筛选。",
    suggestPlatform: "推荐一个任务平台",
    futureRoadmapLabel: "任务平台规划",
    roadmapSourcesTitle: "平台全景",
    roadmapSourcesText: "集中查看长期接单、短期任务、投稿征集与创作者激励平台。",
    roadmapMatchTitle: "条件匹配",
    roadmapMatchText: "按照能力、语言、地区、报酬和交付周期过滤真正适合你的任务。",
    roadmapTrustTitle: "可信提示",
    roadmapTrustText: "标记平台费用、结算方式、作品授权和常见风险，减少无效投入。",
  ...
  en: {
    pageTitle: "AIGC Opportunity Radar | Creative contests and task opportunities",
    ...
    futureKicker: "Next channel",
    futureTitle: "Find the contests. <em>Then find the work.</em>",
    futureIntro: "A future channel will map global freelance, commission, open-call, and creator-incentive platforms, filterable by skill, region, payout, and risk.",
    suggestPlatform: "Suggest a task platform",
    futureRoadmapLabel: "Task platform roadmap",
    roadmapSourcesTitle: "Platform landscape",
    roadmapSourcesText: "Browse freelance marketplaces, short tasks, open calls, and creator incentive programs together.",
    roadmapMatchTitle: "Requirement matching",
    roadmapMatchText: "Filter by skill, language, region, payout, and delivery window to find relevant work.",
    roadmapTrustTitle: "Trust signals",
    roadmapTrustText: "Surface fees, payout methods, licensing terms, and common risks before you invest time.",
    subscribeKicker: "Stay in the loop",
